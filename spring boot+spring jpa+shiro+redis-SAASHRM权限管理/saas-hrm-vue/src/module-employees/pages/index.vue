  ...
  <div class="dashboard-container">
    <div class="app-container">
      ...
      <el-card shadow="never" class="boxMar">
        ...
        <!-- 分页      v-if="show('point-user-delete')"-->
...
import { list, remove, update } from '@/api/base/users';
...
export default {
  ...
  methods: {
      ...
      list(this.requestParameters)
        .then(res => {
          ...
          for (var i = 0; i < this.dataList.length; i++) {
            if (this.dataList[i].enableState === 1) { this.dataList[i].enableState = true; } else { this.dataList[i].enableState = false; }
          }
    ...
    handleStatus (data) {
      if (data.enableState) { data.enableState = 1; } else { data.enableState = 0; }
